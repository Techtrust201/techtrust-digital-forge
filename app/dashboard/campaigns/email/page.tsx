...
export default function EmailCampaignsPage() {
  ...
  const campaignsData = [
    { id: 1, name: 'Newsletter Mensuelle', status: 'Envoyée', sent: 2500, opened: 1250, clicked: 187, openRate: 50, clickRate: 7.5, date: '15 Jan 2024' },
    { id: 2, name: 'Promotion Black Friday', status: 'Planifiée', sent: 0, opened: 0, clicked: 0, openRate: 0, clickRate: 0, date: '24 Nov 2024' },
    { id: 3, name: 'Webinar Growth Hacking', status: 'En cours', sent: 1800, opened: 720, clicked: 108, openRate: 40, clickRate: 6, date: '10 Jan 2024' },
    { id: 4, name: 'Nouveaux Services 2024', status: 'Brouillon', sent: 0, opened: 0, clicked: 0, openRate: 0, clickRate: 0, date: '-' }
  ];
  ...
  const quickStats = [
    { title: "Taux d'ouverture", value: '42.3%', change: '+5.2%', positive: true, icon: Eye },
    { title: 'Taux de clic', value: '6.8%', change: '+1.1%', positive: true, icon: MousePointer },
    { title: 'Abonnés actifs', value: '12,847', change: '+234', positive: true, icon: Users },
    { title: 'Revenus générés', value: '€15,420', change: '+18.7%', positive: true, icon: TrendingUp }
  ];
      ...
      <div className="space-y-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">Créez et gérez vos campagnes email</p>
          </div>
        ...
        <div className="border-b">
          <nav className="flex space-x-8">
            {['campaigns', 'templates', 'analytics'].map((tab) => (
              ...
              >
                {tab === 'campaigns' ? 'Campagnes' : tab === 'templates' ? 'Templates' : 'Analytics'}
              </button>
            ))}
          </nav>
        </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {templatesData.map((template) => (
                  <div key={template.id} className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <div className="text-sm text-gray-600 mb-3">Utilisé {template.usage} fois</div>
