...
export default function SMSCampaignsPage() {
  ...
  const smsCampaignsData = [
    { id: 1, name: 'Promotion Flash 24h', status: 'Envoyé', sent: 1500, delivered: 1478, clicked: 142, deliveryRate: 98.5, clickRate: 9.6, date: '16 Jan 2024', cost: 75 },
    { id: 2, name: 'Rappel RDV Client', status: 'Planifié', sent: 0, delivered: 0, clicked: 0, deliveryRate: 0, clickRate: 0, date: '20 Jan 2024', cost: 25 },
    { id: 3, name: 'Nouveau Service Launch', status: 'En cours', sent: 800, delivered: 784, clicked: 67, deliveryRate: 98, clickRate: 8.4, date: '15 Jan 2024', cost: 40 }
  ];
  ...
  const quickStats = [
    { title: 'Taux de livraison', value: '98.2%', change: '+0.3%', positive: true, icon: Smartphone },
    { title: 'Taux de clic', value: '8.7%', change: '+1.2%', positive: true, icon: MousePointer },
    { title: 'Contacts SMS', value: '8,430', change: '+156', positive: true, icon: Users },
    { title: 'Coût moyen', value: '€0.05', change: '-€0.01', positive: true, icon: DollarSign }
  ];
      ...
      <div className="space-y-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">Gérez vos campagnes SMS efficacement</p>
          </div>
        ...
        <div className="border-b">
          <nav className="flex space-x-8">
            {['campaigns', 'templates', 'analytics'].map((tab) => (
              ...
              >
                {tab === 'campaigns' ? 'Campagnes SMS' : tab === 'templates' ? 'Templates' : 'Analytics'}
              </button>
            ))}
          </nav>
        </div>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Progress value={47} />
                    <p className="text-xs text-gray-600">2,660 SMS restants ce mois</p>
                  </div>
                </CardContent>
              </Card>
            </div>
                  ...
                  <div key={template.id} className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <div className="bg-gray-50 p-3 rounded text-sm mb-3 min-h-[80px]">
                      <p className="text-gray-700">
                        {template.name === 'Promotion Flash' && '🎉 FLASH SALE ! 50% de réduction sur tous nos services pendant 24h. Code: FLASH50'}
                        {template.name === 'Rappel RDV' && 'Bonjour, rappel de votre RDV demain. Confirmez par SMS.'}
                        {template.name === 'Code Promo' && 'Votre code promo exclusif valable 48h !'}
                        {template.name === 'Confirmation Commande' && 'Commande confirmée ! Livraison prévue sous 48h.'}
                      </p>
                    </div>
