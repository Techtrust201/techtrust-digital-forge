...
export default function SocialAnalyticsPage() {
  ...
  const quickStats = [
    { title: 'Total Followers', value: '30,000+', change: '+12.5%', positive: true, icon: Users },
    { title: 'Engagement Moyen', value: '4.2%', change: '+0.8%', positive: true, icon: Heart },
    { title: 'Portée Mensuelle', value: '250K', change: '+18.3%', positive: true, icon: TrendingUp },
    { title: 'Partages', value: '1,248', change: '+25.1%', positive: true, icon: Share }
  ];
                    ...
                    return (
                      <div key={index} className="p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className={`flex items-center gap-1 text-sm ${platform.positive ? 'text-green-600' : 'text-red-600'}`}>
