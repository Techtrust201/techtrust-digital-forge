...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  const { signOut, isAdmin, user, profile } = useSupabaseAuth();
  ...
  useEffect(() => {
    ...
    } else if (path.includes("/dashboard/blog")) {
      setActiveTab("blog");
  ...
  const tierInfo = userData
    ? getTierInfo(userData.tier || 'bronze')
  ...
  const navigationItems: NavItem[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: "Réseaux Sociaux", href: "/dashboard/analytics/social", requiresAdvanced: true },
        { name: "Growth Hacking", href: "/dashboard/analytics/growth", requiresAdvanced: true },
        { name: "Community Management", href: "/dashboard/analytics/community", requiresAdvanced: true },
      ],
    },
    {
      id: "campaigns",
      ...
      submenu: [
        ...
        { name: "Création Contenu", href: "/dashboard/campaigns/content" },
      ],
    },
    {
      id: "account",
      ...
      requiresSubscription: false,
      submenu: [
        { name: "Profil", href: "/dashboard/account/profile" },
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem asChild>
                  <Link href="/dashboard/account">Mon profil</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/dashboard/account">Paramètres</Link>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem
                  onClick={handleLogout}
