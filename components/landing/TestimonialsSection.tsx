      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            Découvrez pourquoi nos clients nous font confiance pour leur transformation digitale.
          </p>
        </div>
          ...
          {testimonials.map((testimonial) => (
            <Card key={testimonial.name} className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white h-full">
              <CardContent className="p-8 h-full flex flex-col">
                {/* Quote icon */}
                <Quote className="w-10 h-10 text-custom-purple/30 mb-4" aria-hidden="true" />
                ...
                <div className="flex-1">
                  ...
                  {/* Étoiles */}
                  <div className="flex mb-6" role="img" aria-label={`Note : ${testimonial.rating} étoiles sur 5`}>
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-custom-blue to-custom-purple rounded-full flex items-center justify-center text-white font-bold mr-4" aria-hidden="true">
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-2 bg-white rounded-full px-6 py-3 shadow-lg">
            <span className="text-gray-700 font-medium">100% code sur mesure</span>
            <span className="text-gray-500 text-sm">• Zéro template, zéro WordPress</span>
          </div>
        </div>
      </div>
    </section>
