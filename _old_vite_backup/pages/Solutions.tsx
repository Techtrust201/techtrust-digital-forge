...
const Solutions = () => {
  return <>
      <Helmet>
        ...
        <meta name="keywords" content="solutions digitales sur mesure, agence web, growth hacking, développement logiciel personnalisé, community management, consulting digital, transformation numérique, site web, e-commerce, application métier, stratégie digitale" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tech-trust.fr/solutions" />
        <meta property="og:title" content="Solutions Digitales Complètes | Web, Growth, Logiciel, Social Media" />
        <meta property="og:description" content="De la création web au growth hacking en passant par le développement sur mesure et le community management. Découvrez l'écosystème digital complet de Techtrust." />
        <meta property="og:image" content="https://www.tech-trust.fr/solutions-og-image.jpg" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://www.tech-trust.fr/solutions" />
        <meta property="twitter:title" content="Solutions Digitales Complètes | Web, Growth, Logiciel, Social Media" />
        <meta property="twitter:description" content="De la création web au growth hacking en passant par le développement sur mesure et le community management. Découvrez l'écosystème digital complet de Techtrust." />
        <meta property="twitter:image" content="https://www.tech-trust.fr/solutions-og-image.jpg" />
        
        {/* Canonical */}
        <link rel="canonical" href="https://www.tech-trust.fr/solutions" />
        
        {/* Hreflang */}
        <link rel="alternate" hrefLang="fr" href="https://www.tech-trust.fr/fr/solutions" />
        <link rel="alternate" hrefLang="en" href="https://www.tech-trust.fr/en/solutions" />
        <link rel="alternate" hrefLang="x-default" href="https://www.tech-trust.fr/solutions" />
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto mb-10">
                  De la <strong>création de site web</strong> au <strong>growth hacking</strong> en passant par le <strong>développement sur mesure</strong> et le <strong>community management</strong>. Un écosystème digital complet pour transformer votre business.
                </p>
                ...
                {solutions.map((solution, index) => <Card key={solution.title} className={`hover:shadow-2xl transition-all duration-300 border-0 shadow-lg h-full ${solution.color === 'blue' ? 'border-t-4 border-t-blue-600' : solution.color === 'purple' ? 'border-t-4 border-t-purple-600' : solution.color === 'green' ? 'border-t-4 border-t-green-600' : solution.color === 'pink' ? 'border-t-4 border-t-pink-600' : solution.color === 'orange' ? 'border-t-4 border-t-orange-600' : 'border-t-4 border-t-gray-600'}`}>
                    <CardContent className="p-8 h-full flex flex-col">
                      ...
                      <div className="flex-1">
                        ...
                        {/* Réalisations */}
                        <div className="mb-6">
                          <span className="text-sm text-gray-500">Nos clients: {solution.clients}</span>
                        </div>
                      </div>
