...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  const { signOut, isAdmin } = useSupabaseAuth();
  ...
  useEffect(() => {
    ...
    if (path.includes("/dashboard/analytics")) {
      ...
      if (path.includes("/dashboard/analytics/website"))
        setActiveSubMenu("/dashboard/analytics/website");
      else if (path.includes("/dashboard/analytics/social"))
        setActiveSubMenu("/dashboard/analytics/social");
      else if (path.includes("/dashboard/analytics/growth"))
        setActiveSubMenu("/dashboard/analytics/growth");
      else if (path.includes("/dashboard/analytics/community"))
        setActiveSubMenu("/dashboard/analytics/community");
      else setActiveSubMenu("/dashboard/analytics/website");
    } else if (path.includes("/dashboard/campaigns")) {
      setActiveTab("campaigns");
      setOpenDropdown("campaigns");
      if (path.includes("/dashboard/campaigns/email"))
        setActiveSubMenu("/dashboard/campaigns/email");
      else if (path.includes("/dashboard/campaigns/sms"))
        setActiveSubMenu("/dashboard/campaigns/sms");
      else if (path.includes("/dashboard/campaigns/leads"))
        setActiveSubMenu("/dashboard/campaigns/leads");
      else if (path.includes("/dashboard/campaigns/automation"))
        setActiveSubMenu("/dashboard/campaigns/automation");
      else setActiveSubMenu("/dashboard/campaigns/email");
    } else if (path.includes("/dashboard/account")) {
      setActiveTab("account");
      setOpenDropdown("account");
      if (path.includes("/dashboard/account/profile"))
        setActiveSubMenu("/dashboard/account/profile");
      else if (path.includes("/dashboard/account/plan"))
        setActiveSubMenu("/dashboard/account/plan");
      else if (path.includes("/dashboard/account/billing"))
        setActiveSubMenu("/dashboard/account/billing");
      else if (path.includes("/dashboard/account/security"))
        setActiveSubMenu("/dashboard/account/security");
      else setActiveSubMenu("/dashboard/account/profile");
    } else if (path.includes("/dashboard/help")) {
      setActiveTab("help");
      setOpenDropdown("help");
      if (path.includes("/dashboard/help/faq"))
        setActiveSubMenu("/dashboard/help/faq");
      else if (path.includes("/dashboard/help/support"))
        setActiveSubMenu("/dashboard/help/support");
      else if (path.includes("/dashboard/help/tutorials"))
        setActiveSubMenu("/dashboard/help/tutorials");
  ...
  const tierInfo = userData
    ? getTierInfo(userData.tier)
    : { icon: Shield, name: "Bronze", color: "text-amber-600" };
        ...
        {userData && (
          <div className="p-6 border-b">
            ...
            <div className="flex items-center gap-2">
              <Badge
                className={`${tierInfo.color} bg-opacity-10 border-current`}
              >
              ...
              {getActivePackages().length > 0 && (
                <Badge variant="outline" className="text-xs">
                  {getActivePackages().length} service
                  {getActivePackages().length > 1 ? "s" : ""}
                </Badge>
              )}
            </div>
          </div>
