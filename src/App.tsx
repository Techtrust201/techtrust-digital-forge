  ...
  return (
    <>
      <Routes>
        ...
        />
        <Route
          path="/solutions/consulting-digital"
          element={<ConsultingDigital />}
        />
        <Route
          path="/solutions/solutions-digitales"
        ...
        />
        <Route
          path="/dashboard/campaigns/email"
          element={
            <ProtectedRoute>
              <EmailCampaigns />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/dashboard/campaigns/leads"
          element={
            <ProtectedRoute>
              <LeadCampaigns />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/dashboard/campaigns/automation"
          element={
            <ProtectedRoute>
              <AutomationCampaigns />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/dashboard/analytics/social"
          element={
            <ProtectedRoute>
              <SocialAnalytics />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/dashboard/analytics/growth"
          element={
            <ProtectedRoute>
              <GrowthAnalytics />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/dashboard/analytics/community"
          element={
            <ProtectedRoute>
              <CommunityAnalytics />
            </ProtectedRoute>
        ...
        <Route
          ...
          element={
            <ProtectedRoute adminOnly>
              <AdminCampaignsSMSPage />
            </ProtectedRoute>
          }
        />
        <Route
          path="/admin/campaigns/automation"
          element={
            <ProtectedRoute adminOnly>
              <AdminCampaignsAutomationPage />
            </ProtectedRoute>
          }
        />
        <Route
