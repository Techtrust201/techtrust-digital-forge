...
const SEO = ({
  ...
  const finalTitle = title.includes('Techtrust') ? title : `${title} | Techtrust`;
  ...
  return (
    <Helmet>
      ...
      <meta name="copyright" content="© 2025 Techtrust. Tous droits réservés." />
      ...
      <meta property="og:site_name" content="Techtrust - Agence Digitale 2025" />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "foundingDate": "2024",
          "description": "Agence digitale française spécialisée en growth hacking IA, création de sites web, community management et solutions sur mesure.",
          "serviceArea": {
            "@type": "Country",
            "name": "France"
          }
