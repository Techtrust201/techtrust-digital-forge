        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/solutions/growth-hacking" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Growth Hacking IA
                </Link>
              </li>
              <li>
                <Link to="/solutions/community-management" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Community Management
                </Link>
              </li>
              <li>
                <Link to="/solutions/agence-web" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Agence Web
                </Link>
              </li>
              <li>
                <Link to="/solutions/consulting-digital" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Consulting Digital
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap gap-6 text-sm text-gray-400 mb-4 md:mb-0">
              <Link to="/legal-mentions" className="hover:text-blue-400 transition-colors">
                Mentions légales
              </Link>
