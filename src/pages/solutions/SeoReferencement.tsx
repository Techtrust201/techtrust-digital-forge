...
const SeoReferencement = () => {
  ...
  return (
    <>
      <Helmet>
        <title>SEO & Référencement | Visibilité Google & IA - Techtrust</title>
        <meta name="description" content="Experts SEO, SEA et GEO : boostez votre visibilité sur Google et les IA (ChatGPT, Perplexity). Audit gratuit, stratégie sur mesure, +500% trafic organique garanti." />
        <meta name="keywords" content="SEO, référencement naturel, Google Ads, SEA, GEO, ChatGPT SEO, Perplexity optimization, référencement Google, agence SEO, audit SEO, backlinks, netlinking, SEO local, Core Web Vitals" />
        
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tech-trust.fr/solutions/seo-referencement" />
        <meta property="og:title" content="SEO & Référencement | Visibilité Google & IA - Techtrust" />
        <meta property="og:description" content="Experts SEO, SEA et GEO : boostez votre visibilité sur Google et les IA. Audit gratuit, +500% trafic organique." />
        <meta property="og:image" content="https://www.tech-trust.fr/solutions/seo-referencement/og-image.jpg" />
        
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://www.tech-trust.fr/solutions/seo-referencement" />
        <meta property="twitter:title" content="SEO & Référencement | Visibilité Google & IA - Techtrust" />
        <meta property="twitter:description" content="Experts SEO, SEA et GEO : boostez votre visibilité sur Google et les IA." />
        
        <link rel="canonical" href="https://www.tech-trust.fr/solutions/seo-referencement" />
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main>
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <motion.span 
                    {...fadeIn} 
                    className="inline-flex items-center gap-2 bg-green-100 rounded-full px-4 py-2 text-sm font-medium text-green-700 mb-6"
                  >
          ...
          {/* GEO Section - L'avenir du référencement */}
