...
const Account = () => {
  ...
  // Mettre à jour le tab selon l'URL
  useEffect(() => {
    if (location.pathname.includes("/account/plan")) setActiveTab("plan");
    else if (location.pathname.includes("/account/billing"))
      setActiveTab("billing");
    else if (location.pathname.includes("/account/security"))
      setActiveTab("security");
    else setActiveTab("profile");
  }, [location.pathname]);

  // Lorsque l'utilisateur change d'onglet via l'UI on change l'URL
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Connexions suspectes et changements
              </p>
            </div>
            <Button variant="outline" size="sm">
              <CheckCircle className="w-4 h-4 mr-2" />
          ...
          {tierInfo.nextTier && (
            <div className="mt-6 pt-6 border-t">
              <div className="flex items-center justify-between mb-4">
                <h4 className="font-medium text-gray-900">
                  Progression vers {tierInfo.nextTier}
                </h4>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Aujourd'hui à 14:30 • Chrome sur macOS
                </p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                <p className="font-medium">Paris, France</p>
                <p className="text-sm text-gray-600">
                  Hier à 09:15 • Safari sur iPhone
                </p>
              </div>
